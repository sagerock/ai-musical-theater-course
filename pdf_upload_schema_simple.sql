-- SIMPLE Database schema for PDF upload feature
-- This version avoids type casting issues entirely
...
-- Temporarily disable storage policies to avoid type casting issues
-- You can enable them later or use application-level security
