      ...
      questions: [
        {
          ...
          answer: 'We offer 5 carefully curated AI models optimized for educational use: GPT-4.1 Mini (cost-effective default) and GPT-4.1 (advanced technical analysis) from OpenAI, Claude Sonnet 4 (analytical excellence) from Anthropic, Gemini Flash (efficient responses) from Google, and Sonar Pro from Perplexity for real-time research with live citations. Each model receives specialized educational prompting to enhance learning outcomes.'
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Each AI model excels at different educational tasks: Claude Sonnet 4 excels at analytical thinking and breaking down complex concepts, GPT-4.1 Mini provides cost-effective general learning, GPT-4.1 handles advanced technical analysis, Gemini Flash delivers quick efficient responses, and Sonar Pro provides real-time information with live citations. Our platform teaches students when to use each model for optimal learning outcomes.'
        },
        {
