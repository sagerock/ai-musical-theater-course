    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Monitor student AI interactions, view analytics, and export data for analysis.
          </p>
        </div>
        <div className="flex items-center space-x-3">
          <button
            onClick={() => setShowAIChat(true)}
            className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700"
          >
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {Math.round(stats.reflectionCompletionRate)}%
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mb-6">
        <p className="text-sm text-gray-600">
          Showing {filteredChats.length} of {chats.length} interactions
