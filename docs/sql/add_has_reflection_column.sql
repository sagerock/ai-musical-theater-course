-- Add has_reflection column to chats table
ALTER TABLE chats ADD COLUMN has_reflection BOOLEAN DEFAULT FALSE;

-- Update the has_reflection field based on actual reflection data
UPDATE chats 
SET has_reflection = (
  SELECT COUNT(*) > 0 
  FROM reflections 
