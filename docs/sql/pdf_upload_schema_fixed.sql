-- FIXED Database schema for PDF upload feature
-- This version has corrected type casting for storage policies
...
-- Storage policies for PDF files - simplified approach
